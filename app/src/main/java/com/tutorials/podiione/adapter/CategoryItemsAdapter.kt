...
class CategoryItemsAdapter : ListAdapter<Response, CategoryItemsAdapter.ViewHolder>(diffObject) {
        ...
        fun bind(response: Response) {
            binding.apply {
                ...
                addToCartBtn.setOnClickListener {
                    addToCartListener?.let { it(response) }
                }
            }
        }
    }
    ...
    private var addToCartListener: ((Response) -> Unit)? = null
    fun addToCartClick(listener: (Response) -> Unit) {
